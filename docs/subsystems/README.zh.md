...
| [scheduler.md](scheduler.zh.md) | 每日挂钟时间任务：已声明与已解析的任务词汇、已校验的重复规则，以及从挂载到释放的时序约定 |
...
| [terminal.md](terminal.zh.md) | 持久化终端 ID、后端/会话约定、发送就绪状态、有界读取、owner 可见快照，以及浏览器驱动的交互式终端 |
