...
| [scheduler.md](scheduler.md) | daily wall-clock tasks: the declared and resolved task vocabulary, the validated recurrence, and the arming-to-release timing contract |
...
| [terminal.md](terminal.md) | persistent terminal ids, backend/session contracts, send readiness, bounded reads, owner-visible snapshots, and the interactive terminals a browser drives |
