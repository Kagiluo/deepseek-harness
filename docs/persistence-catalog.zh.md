...
| `id` | 必需 | `string` |
| `role` | 必需 | `"developer"` |
| `source` | 必需 | [`MessageSource`](#persistence-type-sha256-d92ffe77db0a0c0701a8bd6aa45b37e4955202d528b587fe676a8224d40b7b6f) |

消息源兼容策略：`source` — `session-source-attribution` v1; `session.developer-message.source`; `kind`; `preserve`.

仅表示归属的新增 kind：`scheduler`, `tmux-context`.
...
[`Message`](#persistence-type-sha256-b4f42ad26226080f3bf38ed98cfc55d5bb4da705516674dfa4f6d9401be3aad2) 的数组。
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-e7bc6816f5c57862065f514f522bfddd920e14b25de2aa5cc7216d77304cce5c) |
...
[`UserMessage`](#persistence-type-sha256-11d7802e049c9dac8ecd75e53580189263f0f048066af5dfa62aac06e3347019) 的数组。
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-4b81071ad17a8ff7993da6d454cce89bcf36a74e8f725a122cd913b350cc25f2) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-9805b07955016bc4297df985826e87750b5877f255f7923602d1ac38eb61cceb) |
| `outcome` | 可选 | `"canceled"` |
...
来源：[`packages/scheduler/scheduler/src/types.ts:77`](../packages/scheduler/scheduler/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `form` | 必需 | `"notice"` |
| `kind` | 必需 | `"scheduler"` |
| `occurrenceAt` | 必需 | `string` |
| `summary` | 必需 | `string` |
| `taskId` | 必需 | `string` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-5b2df2ed03aee625f215d8954d79d804d06b9d0afd1065598fff79d78e476c2b) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-cc12d23a9efd4b3a5ba621add02edade3bb96cfc022a9448c53477a6db5ff842) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-5e71165ec53f67920d0a89e54779abb6a4f7da39b62960fb9c412c26d565def7) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-11d7802e049c9dac8ecd75e53580189263f0f048066af5dfa62aac06e3347019) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
