...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-theme-nord': { kind: 'none', reason: 'Browser-side appearance layer deriving alias tokens and a background image; registers nothing model-facing.' },
  ...
  'packages/client/ui-terminal': { kind: 'none', reason: 'Browser-only interactive terminal surface; registers no tool, prompt section, or session event, and nothing the user types into it enters a model request.' },
  ...
  'packages/terminal/terminal-interactive': { kind: 'none', reason: 'The seam allocates raw terminals for a user interface; it registers no tool, prompt section, or session event, and the model-facing persistent terminal seam is dsh-terminal.' },
  'packages/terminal/terminal-interactive-local': { kind: 'none', reason: 'The provider backend allocates one local PTY for the browser terminal surface; it registers no tool, prompt section, or session event.' },
  ...
  'packages/api/terminal-controller': { kind: 'none', reason: 'Browser terminal API and transport owner; the invoked methods register no prompt, tool, or session event.' },
