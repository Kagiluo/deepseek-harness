...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  interactiveTerminals: 'terminal.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  InteractiveTerminalBackendSession: 'terminal.md',
  InteractiveTerminalFrame: 'terminal.md',
  InteractiveTerminalId: 'terminal.md',
  InteractiveTerminalIdValue: 'terminal.md',
  InteractiveTerminalOpenRequest: 'terminal.md',
  InteractiveTerminalOpenSpec: 'terminal.md',
  InteractiveTerminalProvider: 'terminal.md',
  InteractiveTerminalSnapshot: 'terminal.md',
  InteractiveTerminalStatus: 'terminal.md',
  TerminalCloseResult: 'terminal.md',
  TerminalFrame: 'terminal.md',
  TerminalListRequest: 'terminal.md',
  TerminalOpenRequest: 'terminal.md',
  TerminalResizeRequest: 'terminal.md',
  TerminalSnapshot: 'terminal.md',
  TerminalTarget: 'terminal.md',
  TerminalWireStatus: 'terminal.md',
